...
def transform_srcProduct():
    ...
    revised['ProductLine'].fillna('0', inplace=True)
    revised['DealerPrice'].fillna('0', inplace=True)
    revised['Class'].fillna('0', inplace=True)
    revised['Style'].fillna('0', inplace=True)
    revised['ModelName'].fillna('0', inplace=True)
    revised['EnglishDescription'].fillna('0', inplace=True)
    ...
    return {"table(s) processed ": "Data imported succesful"}
